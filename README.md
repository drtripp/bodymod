...
- persisted locale preference with a lightweight i18n message catalog for the
  ...
  shell/magic-link identity/share/widget/health-sync/live-update/export/report
  controls, and printable progress
...
- full app-wide translation coverage; current i18n work covers the shell,
  ...
  identity/share/widget/health-sync/live-update/export/report controls, and generated progress report copy, while
