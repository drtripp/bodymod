...
- persisted locale preference with a lightweight i18n message catalog for the
  ...
  native-backup/encrypted-sync/auto-sync/personal-data-api/export/report
...
- full app-wide translation coverage; current i18n work covers the shell,
  ...
  encrypted-sync/auto-sync/personal-data-api/export/report controls, and
  generated progress report copy, while
