...
- persisted locale preference with a lightweight i18n message catalog for the
  ...
  states, and generated body rows
...
- full app-wide translation coverage; current i18n work covers the shell,
  ...
  controls, and generated progress report copy, while deeper account feature
  panes plus source, seed, and user-authored content remain English-first
