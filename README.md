...
- persisted locale preference with a lightweight i18n message catalog for the
  ...
  chrome/status strings, and printable progress report headings/empty states
...
- full app-wide translation coverage; current i18n work covers the shell,
  ...
  strings, and progress report headings/empty states, while deeper account,
  strategy, and long-form report copy remains English-first
