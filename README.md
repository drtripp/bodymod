...
- persisted locale preference with a lightweight i18n message catalog for the
  ...
  referral/data-explainer/face-measurement/export/report controls, and printable progress
...
- full app-wide translation coverage; current i18n work covers the shell,
  ...
  data-explainer/face-measurement/photo-log/export/report controls, and generated progress report copy,
