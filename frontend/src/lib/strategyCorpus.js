...
export const strategyCaseLogs = normalizeStrategyCaseLogs([
  {
    ...
    projectionSummary: "NIDDK/Hall 2011 linearized planning band: +3.1 kg over 84 days",
  ...
  },
  {
    ...
    projectionSummary: "NIDDK/Hall 2011 linearized planning band: -3.7 kg over 70 days",
    sourceType: "seeded completed protocol",
    reviewStatus: "dummy data for product validation",
