...
| i18n groundwork | `frontend/src/lib/i18n.js`, `frontend/src/lib/progressReport.js`, `frontend/src/App.jsx`, `frontend/src/components/SiteHeader.jsx`, `frontend/src/components/OnboardingPanel.jsx`, `frontend/src/components/MeasurementForm.jsx`, `frontend/src/components/DietDashboard.jsx`, `frontend/tests/i18n.node.mjs`, `frontend/tests/progressReport.node.mjs`, and Playwright shell/diet/report coverage implement persisted locale selection, a message catalog, fallback/interpolation helpers, English/Spanish top-level shell/header/tab strings, first-run onboarding copy, measurement categories/field labels/help, unit controls, measurement-guide chrome, Diet dashboard chrome/status strings, and printable progress-report headings/empty states. | Expanded groundwork done; deeper account/strategy and long-form report translation pending |
