...
- [x] i18n groundwork **(new)**: extract user-facing strings behind a
      ...
      personal-data-api/entitlement/referral/data-explainer/face-measurement/bloodwork/workout/photo-log/export/report status strings, Diet dashboard chrome/status
      ...
      entitlement/referral/data-explainer/face-measurement/bloodwork/workout/photo-log/report workflow.
