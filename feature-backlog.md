...
- [x] i18n groundwork **(new)**: extract user-facing strings behind a
      ...
      measurement-guide chrome, account shell/magic-link identity/export/report
      ...
      output and dynamic report rows, account identity/export/report status
      ...
      account identity/report workflow. Full app-wide copy extraction, deeper
