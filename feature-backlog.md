...
- [x] i18n groundwork **(new)**: extract user-facing strings behind a
      ...
      personal-data-api/entitlement/referral/data-explainer/export/report
      ...
      personal-data-api/entitlement/referral/data-explainer/export/report status strings, Diet dashboard chrome/status
      ...
      entitlement/referral/data-explainer/report workflow.
